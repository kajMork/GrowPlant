...
void textures::loadTextures()
{
    ...
    if(!terase.loadFromFile("/Users/madsrossen/Documents/GitHub/GrowPlant/pictures/TeraseV2.png")){
        std::cout << "Couldn't load textures, check directory." << std::endl;
    }
    terase.setSmooth(true);

    
    if(!sky.loadFromFile("/Users/madsrossen/Documents/GitHub/GrowPlant/pictures/Sky.png")){
        std::cout << "Couldn't load textures, check directory." << std::endl;
    }
    sky.setSmooth(true);

    
    if(!tomatoesTex.loadFromFile("/Users/madsrossen/Documents/GitHub/GrowPlant/pictures/tomatoes.png")){
        std::cout << "Couldn't load textures, check directory." << std::endl;
    }
    tomatoesTex.setSmooth(true);

    
    if(!cucumberTex.loadFromFile("/Users/madsrossen/Documents/GitHub/GrowPlant/pictures/Cucumber.png")){
        std::cout << "Couldn't load textures, check directory." << std::endl;
    }
    cucumberTex.setSmooth(true);

    
    if(!lightTex.loadFromFile("/Users/madsrossen/Documents/GitHub/GrowPlant/pictures/light_PNG14427.png")){
        std::cout << "Couldn't load textures, check directory." << std::endl;
    }
...
std::vector<sf::RectangleShape> textures::setupPlantBranches(sf::RectangleShape branch1, sf::RectangleShape branch2, sf::RectangleShape branch3, int x_pos, int y_pos)
{
    ...
    {       
            vec[i].setSize(sf::Vector2f(5.0, - height_stalk/2));
