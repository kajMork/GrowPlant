...
int main(int argc, char const *argv[])
{
    ...
    sf::Texture tomatoes;
    if(!tomatoes.loadFromFile("/Users/madsrossen/Documents/GitHub/GrowPlant/pictures/tomatoes.jpg")){
        std::cout << "Couldn't load textures, check directory." << std::endl;
    }
    tomatoes.setSmooth(true);

    sf::Texture cucumber;
    if(!cucumber.loadFromFile("/Users/madsrossen/Documents/GitHub/GrowPlant/pictures/Cucumber.jpg")){
        std::cout << "Couldn't load textures, check directory." << std::endl;
    }
    ...
    sf::Texture sun;
    if(!sun.loadFromFile("/Users/madsrossen/Documents/GitHub/GrowPlant/pictures/SunV3.png")){
        std::cout << "Couldn't load textures, check directory." << std::endl;
    }
    sun.setSmooth(true);
