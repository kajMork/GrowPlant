...
#include "../include/light_regulation.h"
#include <vector>
#include <ctime>
#include <cstdlib>
#include <string>
...
void lightadjust(lightRegulation &a_lightregulation){

     if (a_lightregulation.getLUXlevel()!=a_lightregulation.getwishedLUXlevel())               
        {
            a_lightregulation.adjustlight(1);
        }
}
...
int main(int argc, char const *argv[])
{
    ...
    lightRegulation my_lightregulation;
    ...
    while (end==false)
    {
        ...
        lightadjust(my_lightregulation);
        ...
        cout << "Actual lightvalue:"<< my_lightregulation.getLUXlevel()<< endl;
